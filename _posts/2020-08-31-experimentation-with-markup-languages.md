...
This was just a quick fun/update post, if you'd like to see the source code it's hosted on GitHub [here](https://github.com/Owez/superconf). The package has no dependancies and is extremely lightweight at only ~330 lines (including tests)!
